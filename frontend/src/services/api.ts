...
export const analyticsApi = {
    ...
    async getTopProducts(filters: Filters, limit = 10): Promise<Product[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/products/top?${params}`)
    ...
    async getSalesByChannel(filters: Filters): Promise<Channel[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/channels?${params}`)
    ...
    async getSalesTimeSeries(filters: Filters): Promise<TimeSeriesData[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/time-series?${params}`)
    ...
    async getSalesByHour(filters: Filters): Promise<HourlyData[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/sales-by-hour?${params}`)
    ...
    async getSalesByWeekday(filters: Filters): Promise<WeekdayData[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/sales-by-weekday?${params}`)
    ...
    async getTopStores(filters: Filters, limit = 10): Promise<Store[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/stores/top?${params}`)
    ...
    async getTopCustomizations(filters: Filters, limit = 10): Promise<Customization[]> {
        ...
        const response = await fetch(`${API_BASE}/analytics/customizations/top?${params}`)
...
export const filtersApi = {
    async getStores(): Promise<Store[]> {
        const response = await fetch(`${API_BASE}/filters/stores`)
        if (!response.ok) throw new Error('Failed to fetch stores')
        return response.json()
    },

    async getChannels(): Promise<Channel[]> {
        const response = await fetch(`${API_BASE}/filters/channels`)
        if (!response.ok) throw new Error('Failed to fetch channels')
        return response.json()
    },

    async getDateRange(): Promise<{ min_date: string; max_date: string }> {
        const response = await fetch(`${API_BASE}/filters/date-range`)
